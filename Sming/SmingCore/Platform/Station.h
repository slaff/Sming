...
public:
	 ...
	 *	@param  persist True to save the SSID and password in Flash. False otherwise. (Default: True)
	 */
	bool config(String ssid, String password, bool autoConnectOnStartup = true, bool persist = true);
